...
export class AutomationController {
  ...
  async create(@Body() dto: CreateAutomationRuleDto, @Request() req) {
   ...
   */
  @Get()
  @RequirePermissions(['admin:automation', 'automation:read'], 'any')
   ...
   */
  @Get(':id/stats')
  @RequirePermissions(['admin:automation', 'reports:read'], 'any')
