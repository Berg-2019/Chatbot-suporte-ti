...
| [`DEPENDENCY_UPGRADE_PLAN.md`](DEPENDENCY_UPGRADE_PLAN.md) | **Roadmap de upgrades MAJOR** de dependências (Prisma, amqplib, zod, recharts, TypeScript/Vite etc.) — executar aos poucos em janelas de manutenção de fim de semana |
